package org.example.hit.heal.hitber.naming.components
...
val imageNames = mapOf(
    Res.drawable.pencil to "עיפרון",
    Res.drawable.ruler to "סרגל",
    Res.drawable.table to "שולחן",
    Res.drawable.ball to "כדור",
    Res.drawable.balloon to "בלון",
    Res.drawable.lemon to "לימון"
)
