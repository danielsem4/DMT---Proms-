    ...
    if (isPlaying) {
        ...
        Row(
            ...
            drawArc(
                ...
                sweepAngle = 180f,
                useCenter = false,
                topLeft = Offset(centerX - (size1 / 2), centerY - (size1 / 2) + adjustedOffsetY),
            ...
            drawArc(
                ...
                sweepAngle = 180f,
                useCenter = false,
                topLeft = Offset(centerX - (size2 / 2), centerY - (size2 / 2) + adjustedOffsetY),
            ...
            drawArc(
                ...
                sweepAngle = 180f,
                useCenter = false,
                topLeft = Offset(centerX - (size3 / 2), centerY - (size3 / 2) + adjustedOffsetY),
